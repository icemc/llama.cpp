...
GGML_API void   quantize_row_q4_C_64_ref (const float * GGML_RESTRICT x, block_q4_C_64  * GGML_RESTRICT y, int64_t k);
GGML_API void   dequantize_row_q4_C_64   (const block_q4_C_64  * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_q4_C_64         (const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);

GGML_API void   quantize_row_q4_C_128_ref(const float * GGML_RESTRICT x, block_q4_C_128 * GGML_RESTRICT y, int64_t k);
GGML_API void   dequantize_row_q4_C_128  (const block_q4_C_128 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_q4_C_128        (const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);

// Q4_KCA: Cache-Line-Aligned K-Quant (K-quant 6-bit sub-scales, uniform nibbles)
GGML_API void   quantize_row_q4_KCA_64_ref (const float * GGML_RESTRICT x, block_q4_KCA_64  * GGML_RESTRICT y, int64_t k);
GGML_API void   dequantize_row_q4_KCA_64   (const block_q4_KCA_64  * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_q4_KCA_64         (const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);

GGML_API void   quantize_row_q4_KCA_128_ref(const float * GGML_RESTRICT x, block_q4_KCA_128 * GGML_RESTRICT y, int64_t k);
GGML_API void   dequantize_row_q4_KCA_128  (const block_q4_KCA_128 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API size_t quantize_q4_KCA_128        (const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
