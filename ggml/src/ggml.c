...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_BLAQ_SKA_128] = {
        .type_name                = "blaq_ska_128",
        .blck_size                = QK_BLAQ_SKA_128,
        .type_size                = sizeof(block_blaq_ska_128),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t)   dequantize_row_blaq_ska_128,
        .from_float_ref           = (ggml_from_float_t)  quantize_row_blaq_ska_128_ref,
    },
    [GGML_TYPE_BLAQ_SKA_256] = {
        .type_name                = "blaq_ska_256",
        .blck_size                = QK_BLAQ_SKA_256,
        .type_size                = sizeof(block_blaq_ska_256),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t)   dequantize_row_blaq_ska_256,
        .from_float_ref           = (ggml_from_float_t)  quantize_row_blaq_ska_256_ref,
    },
    [GGML_TYPE_Q2_K] = {
        .type_name                = "q2_K",
        .blck_size                = QK_K,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_BLAQ_SKA_128: result = quantize_blaq_ska_128(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_BLAQ_SKA_256: result = quantize_blaq_ska_256(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
