...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q4_C_64] = {
        .from_float               = quantize_row_q4_C_64,
        .vec_dot                  = ggml_vec_dot_q4_C_64_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q4_C_128] = {
        .from_float               = quantize_row_q4_C_128,
        .vec_dot                  = ggml_vec_dot_q4_C_128_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q4_KCA_64] = {
        .from_float               = quantize_row_q4_KCA_64,
        .vec_dot                  = ggml_vec_dot_q4_KCA_64_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q4_KCA_128] = {
        .from_float               = quantize_row_q4_KCA_128,
        .vec_dot                  = ggml_vec_dot_q4_KCA_128_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q2_K] = {
