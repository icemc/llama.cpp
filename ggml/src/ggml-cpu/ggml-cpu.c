...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_BLAQ_Q4_128] = {
        .from_float               = quantize_row_blaq_q4_128,
        .vec_dot                  = ggml_vec_dot_blaq_q4_128_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_BLAQ_Q4_256] = {
        .from_float               = quantize_row_blaq_q4_256,
        .vec_dot                  = ggml_vec_dot_blaq_q4_256_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_BLAQ_RD_Q4_CL64] = {
        .from_float               = quantize_row_blaq_rd_q4_cl64,
        .vec_dot                  = ggml_vec_dot_blaq_rd_q4_cl64_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_BLAQ_RD_Q4_CL128] = {
        .from_float               = quantize_row_blaq_rd_q4_cl128,
        .vec_dot                  = ggml_vec_dot_blaq_rd_q4_cl128_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_Q2_K] = {
