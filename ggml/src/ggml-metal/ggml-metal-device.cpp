...
ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_mul_mv(ggml_metal_library_t lib, const ggml_tensor * op) {
    ...
    switch (tsrc0) {
        ...
        case GGML_TYPE_BLAQ_Q4_128:
            {
                nsg = N_SG_BLAQ_Q4_128;
                nr0 = N_R0_BLAQ_Q4_128;
                smem = 32*sizeof(float)*N_R0_BLAQ_Q4_128;
            } break;
        ...
        case GGML_TYPE_BLAQ_RD_Q4_CL64:
            {
                nsg = N_SG_BLAQ_RD_Q4_CL64;
                nr0 = N_R0_BLAQ_RD_Q4_CL64;
                smem = 32*sizeof(float)*N_R0_BLAQ_RD_Q4_CL64;
            } break;
        case GGML_TYPE_BLAQ_RD_Q4_CL128:
            {
                nsg = N_SG_BLAQ_RD_Q4_CL128;
                nr0 = N_R0_BLAQ_RD_Q4_CL128;
                smem = 32*sizeof(float)*N_R0_BLAQ_RD_Q4_CL128;
            } break;
        default:
            {
